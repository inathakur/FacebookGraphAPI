...
vid=344128252278047 #This is flipkart page's facebook id
...
if char1=='y':
    ...
    if nos<=len(idlist):
       for indid in idlist[len(idlist)-(nos):len(idlist)-1]:
    	  count=count+1
          facebook.publish(cat="comments",id=indid,message="Salmans new movie:Shuuddhi2015 https://www.facebook.com/pages/Shhuddhi-2016/968252999851897?ref=hl"+str(count))
	  time.sleep(1)
